      ...
      <form onSubmit={submit} className="space-y-5">
        <div className="flex items-center gap-4">
          <button
            ...
            className="w-16 h-16 rounded-full overflow-hidden border-2 border-dashed border-line hover:border-signal bg-panel2 flex items-center justify-center flex-shrink-0 transition-colors"
          >
            {avatar ? (
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full bg-panel border border-line rounded-lg px-3.5 py-2.5 text-sm outline-none focus:border-signal placeholder:text-muted"
          />
        </div>
        ...
        <div className="flex gap-3 pt-2">
          <button
            type="submit"
            className="flex-1 bg-signal text-ink font-semibold py-2.5 rounded-lg hover:bg-signal2 transition-colors"
          >
          ...
          {existing && (
            <button
              type="button"
              onClick={onDone}
              className="px-5 py-2.5 rounded-lg border border-line text-muted hover:text-paper transition-colors"
            >
              Cancel
            </button>
          )}
